...
namespace GP8000.Personnel
{
	...
	/// </summary>
	public class frmTaStaffSalary : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button cmd_trans;
		private C1.C1Pdf.C1PdfDocument _c1pdf;
		private System.ComponentModel.IContainer components;		

		public frmTaStaffSalary()
		{			
			InitializeComponent();				
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmTaStaffSalary));
			...
			this.cmd_trans = new System.Windows.Forms.Button();
			...
			this.panel2.Size = new System.Drawing.Size(976, 663);
			...
			this.groupBox1.Size = new System.Drawing.Size(968, 665);
			...
			this.rpt.Size = new System.Drawing.Size(99, 28);
			this.rpt.TabIndex = 143;
			this.rpt.Visible = false;
			// 
			// txt_BIR_DT
			// 
			this.txt_BIR_DT.Location = new System.Drawing.Point(108, 72);
			...
			this.c1DockingTab3.Location = new System.Drawing.Point(544, 284);
			...
			this.cmd_browser.Visible = false;
			...
			this.lb2.Location = new System.Drawing.Point(543, 172);
			this.lb2.Name = "lb2";
			...
			// lb1
			// 
			this.lb1.Location = new System.Drawing.Point(572, 176);
			this.lb1.Name = "lb1";
			...
			// label54
			// 
			this.label54.Location = new System.Drawing.Point(572, 156);
			...
			this.ck_DIR_BT.Location = new System.Drawing.Point(548, 152);
			...
			// label49
			// 
			this.label49.Location = new System.Drawing.Point(572, 136);
			...
			this.ck_BHX_BT.Location = new System.Drawing.Point(548, 132);
			...
			// label37
			// 
			this.label37.Location = new System.Drawing.Point(572, 116);
			...
			this.ck_LCK_BT.Location = new System.Drawing.Point(548, 112);
			...
			this.label35.Location = new System.Drawing.Point(572, 96);
			...
			this.ck_ATT_BT.Location = new System.Drawing.Point(548, 92);
			...
			// label33
			// 
			this.label33.Location = new System.Drawing.Point(572, 76);
			...
			this.ck_MEA_BT.Location = new System.Drawing.Point(548, 72);
			...
			// label32
			// 
			this.label32.Location = new System.Drawing.Point(572, 56);
			...
			this.ck_NEW_BT.Location = new System.Drawing.Point(548, 52);
			...
			// label20
			// 
			this.label20.Location = new System.Drawing.Point(572, 36);
			...
			// label19
			// 
			this.label19.Location = new System.Drawing.Point(572, 16);
			...
			this.ck_MAR_BT.Location = new System.Drawing.Point(548, 32);
			...
			this.ck_SEX_BT.Location = new System.Drawing.Point(548, 12);
			...
			this.panel6.Controls.Add(this.cmd_trans);
			...
			this.panel6.Size = new System.Drawing.Size(976, 32);
			this.panel6.TabIndex = 3;
			// 
			// cmd_trans
			// 
			this.cmd_trans.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.cmd_trans.Location = new System.Drawing.Point(756, 4);
			this.cmd_trans.Name = "cmd_trans";
			this.cmd_trans.Size = new System.Drawing.Size(116, 24);
			this.cmd_trans.TabIndex = 138;
			this.cmd_trans.Text = "Vacate";
			this.cmd_trans.Click += new System.EventHandler(this.cmd_trans_Click);
			// 
			// ck_QEdit
			// 
			this.ck_QEdit.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.ck_QEdit.Location = new System.Drawing.Point(760, 4);
			...
			this.ck_search.Location = new System.Drawing.Point(648, 4);
			...
			this.c1CommandDock2.Location = new System.Drawing.Point(976, 0);
			this.c1CommandDock2.Name = "c1CommandDock2";
			this.c1CommandDock2.Size = new System.Drawing.Size(28, 695);
			// 
			// c1DockingTab2
			// 
			...
			this.c1DockingTab2.Size = new System.Drawing.Size(28, 695);
			...
			this.c1DockingTabPage2.Size = new System.Drawing.Size(23, 693);
			...
			this.vs.Name = "vs";
			this.vs.Size = new System.Drawing.Size(23, 673);
			...
			this.Dep.Name = "Dep";
			this.Dep.Size = new System.Drawing.Size(11, 708);
			this.Dep.TabIndex = 0;
			// 
			// frmTaStaffSalary
			// 
			...
			this.Name = "frmTaStaffSalary";
			this.Text = "frmTaStaffSalary";
		...
		private void ShowData()
		{
			...
			cb_DEP_ID.Enabled=cb_POS_ID.Enabled=(vs.Row>0 && vs.Rows[vs.Row].UserData+""=="2") ;
		...
		{					
			...
			if (e.Button.Equals(nav.cmd_save))
			{
				if(vs.Row<=0)
					return;
				if(txt_EMP_ID.Text+""=="" && (PublicFunction.WIDLEN<=0))
				{
...
//				else
		...
		private void S_EMP_ID_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if(e.KeyCode==Keys.Enter)
			{
				...
				sql= ((TextBox)sender).Tag+sql+" and (DEL_BT is null or DEL_BT=0) and DEP_ID in "+T_String.DEP_ID(this.Tag);					
				nav.Show_VS(sql);				
				ShowData();				 	 
			}
		}
...
//				rcCell.Height = Math.Max(rcCell.Height, height);
		...
		private void cmd_trans_Click(object sender, System.EventArgs e)
		{
