...
namespace GP8000.Attendance
{
	...
	/// </summary>
	public class frmTaManternity : System.Windows.Forms.Form
	{		
		...
		public frmTaManternity(string wh,C1.Win.C1FlexGrid.C1FlexGrid vs3)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmTaManternity";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "frmTaManternity";
		...
		private void menu_Click(object sender, EventArgs e)
		{
			...
			switch (mnu1.MenuItems.IndexOf((MenuItem)sender))
			{
				case 0:		
					...
					rpt.RPT2(c1XLBook1,vs,mnu1.MenuItems[mnu1.MenuItems.IndexOf((MenuItem)sender)].Text,"STD_TA_07");					
					break;
		...
		private void textBox1_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if(e.KeyCode==Keys.Enter)
			{
				...
				sql=sql+" and DEP_ID in (Select DEP_ID  from SYS_SECURITY_DEP"+
					" where MNU_ID="+this.Tag+" and ALL_BT=1  and USER_ID=N'"+PublicFunction.A_UserID+"') and (SEX_BT=0 or SEX_BT is null)";					
				nav1.Show_VS(sql);	
				Show_VS1();	
			}
		}
		...
		{				
			if (e.Button.Equals(nav1.cmd_refresh))
			{
				if(nav1.wh!="")
					...
					nav1.Show_VS("DEP_ID in "+T_String.DEP_ID(this.Tag) + " and (SEX_BT=0 or SEX_BT is null)");				
				return;
			}
			nav1.ToolBar_Click(e);					
		}
