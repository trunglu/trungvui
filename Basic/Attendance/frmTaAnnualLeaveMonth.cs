...
namespace GP8000.Attendance
{
	...
	/// </summary>
	public class frmTaAnnualLeaveMonth : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.RadioButton optVacate;
		private System.Windows.Forms.RadioButton optWorking;
...
//					nav.Show_VS("DEP_ID in "+T_String.DEP_ID(this.Tag));	
					...
					else
					{
						...
						else
						{
							...
							else
							{
								...
								{
									nav.Show_VS("DEP_ID=N'"+Dep.Get_Data("DEP_ID")+"' and YYY_YY=N'"+ dt.Text+"' and (VAC_BT=0 or VAC_BT is null)");				
								}
								else
								{
									nav.Show_VS("DEP_ID=N'"+Dep.Get_Data("DEP_ID")+"' and YYY_YY=N'"+ dt.Text+"' and VAC_BT=1");				
								}
							}
		...
		private void textBox1_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			...
			{					
				...
				if(((TextBox)sender).Text+""!="")
					...
					sql="1=1";						
				sql=sql+" and  (VAC_BT=0 or VAC_BT is null)  and YYY_YY=N'"+ dt.Text+"' and DEP_ID in (Select DEP_ID  from SYS_SECURITY_DEP"+
		...
		private void cmd_set_Click(object sender, System.EventArgs e)
		{					
		...
		{
			frmTaCalAnnualLeaveMonth dlg=new frmTaCalAnnualLeaveMonth( DateTime.Parse( dt.Value+"") );
			dlg.Tag=this.Tag;
			dlg.ShowDialog();
		}
		...
		{
			frmTaTransferNextYearMonth dlg=new frmTaTransferNextYearMonth();
			dlg.Tag=this.Tag;
			dlg.ShowDialog();
		}
