...
namespace GP8000.Attendance
{
	...
	/// </summary>
	public class frmTaTransferNextYearMonth : System.Windows.Forms.Form
	{
		...
		public frmTaTransferNextYearMonth()
		{
		...
		private void TransferStaff(string EMP_ID,SqlConnection con)
		{
			...
			sql="update FILC04B set LST_QT="+songay+" where EMP_ID=N'"+EMP_ID+"' and YYY_YY=N'"+
				((int)(T_String.IsNullTo0(YYY_YY.Text)+1)).ToString("000000")+"'";
