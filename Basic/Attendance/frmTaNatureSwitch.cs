...
namespace GP8000.Personnel
{
	...
	/// </summary>
	public class frmTaNatureSwitch : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel1.Size = new System.Drawing.Size(804, 676);
			...
			this.panel2.Size = new System.Drawing.Size(804, 640);
			...
			this.panel6.Size = new System.Drawing.Size(804, 640);
			...
			this.panel8.Size = new System.Drawing.Size(804, 356);
			...
			this.panel12.Size = new System.Drawing.Size(804, 252);
			...
			this.vs2.Name = "vs2";
			this.vs2.Size = new System.Drawing.Size(796, 220);
			...
			this.panel11.Size = new System.Drawing.Size(804, 104);
			this.panel11.TabIndex = 40;
			// 
			// cmd_ok
			// 
			this.cmd_ok.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.cmd_ok.Location = new System.Drawing.Point(320, 64);
			...
			this.txt_note.Location = new System.Drawing.Point(456, 4);
			this.txt_note.MaxLength = 100;
			this.txt_note.Multiline = true;
			this.txt_note.Name = "txt_note";
			this.txt_note.ScrollBars = System.Windows.Forms.ScrollBars.Both;
			this.txt_note.Size = new System.Drawing.Size(344, 48);
			...
			this.dt1.Location = new System.Drawing.Point(108, 32);
			this.dt1.Name = "dt1";
			...
			this.cb.Location = new System.Drawing.Point(108, 4);
			this.cb.Name = "cb";
			...
			this.splitter1.Size = new System.Drawing.Size(804, 4);
			...
			this.panel7.Size = new System.Drawing.Size(804, 280);
			...
			this.panel10.Size = new System.Drawing.Size(413, 280);
			...
			this.vs1.Name = "vs1";
			this.vs1.Size = new System.Drawing.Size(404, 248);
			...
			this.panel3.Size = new System.Drawing.Size(804, 36);
			...
			this.cmd_clear.Location = new System.Drawing.Point(692, 4);
			...
			this.label5.Size = new System.Drawing.Size(796, 36);
			...
			this.Name = "frmTaNatureSwitch";
			this.Text = "frmTaNatureSwitch";
			this.Load += new System.EventHandler(this.frmTaNatureSwitch_Load);
		...
		private void frmTaNatureSwitch_Load(object sender, System.EventArgs e)
		{
			Init_Form();	
			Init_CB();			
		...
		{		
			nav2.cmd_add.Visible=nav2.cmd_exit.Visible=nav2.cmd_copy.Visible=nav2.cmd_refresh.Visible=nav2.cmd_report.Visible =false ;			
			...
			vs2.Cols["INH_DT"].DataType=typeof(System.DateTime);
			vs2.Cols["INH_DT"].Format=PublicFunction.GetOption("DATE");
		...
		private void nav2_TBarClick(object sender, ToolBarButtonClickEventArgs e)
		{
			if (e.Button.Equals(nav2.cmd_delete))
			{
				...
				string TYP_ID=vs2.Rows[vs2.Row]["TYP_I2"]+"";
				string INH_DT=vs2.Rows[vs2.Row]["INH_DT"]+"";
				DateTime dtt=DateTime.Parse(vs2.Rows[vs2.Row]["SWI_DT"]+"");
				//chi xoa duoc dong cuoi cung
				if(T_String.IsNullTo0(T_String.GetDataFromSQL("count(*)","FILB09A","EMP_ID='"+EMP_ID+"' AND SWI_DT>'"+dtt.ToString("yyyy/MM/dd")+"'"))>0)
				{
...
//				{
//					dtt=new DateTime(dtt.Year+1,1,1) ;
//					dtt=dtt.AddDays(-1);
//				}
//				else
//					dtt=T_String.GetDate();
				SqlConnection con1=new SqlConnection(PublicFunction.C_con.ConnectionString);
				con1.Open();
				nav2.ToolBar_Click(e);
				//update nv
//				if(T_String.IsNullTo0(T_String.GetDataFromSQL("count(*)","FILB09A","EMP_ID='"+EMP_ID+"' AND YEAR(SWI_DT)="+dtt.Year))==0)
//				{
					string ssql="UPDATE FILB01A SET TYP_ID='"+TYP_ID+"' where EMP_ID='" + EMP_ID +"'";
					PublicFunction.SQL_Execute(ssql,con1);
//				}
//				if(PublicFunction.tinhphepnam==0)
//				{						 
//					frmTaCalAnnualLeave.CalStaff(EMP_ID,TYP_ID,INH_DT,con1,dtt.ToString("yyyy"),dtt,false);
//				}
//				else
//				{ 
//					frmTaCalAnnualLeave.CalStaff1(EMP_ID,TYP_ID,INH_DT,con1,dtt);
//				}
		...
		private void  Init_CB()
		{
			...
			vs2.Cols["TYP_I1"].DataMap=PublicFunction.InitCBForVS(sql,false);
			vs2.Cols["TYP_I2"].DataMap=PublicFunction.InitCBForVS(sql,false);
		...
		{			
			DateTime dt=DateTime.Parse(dt1.Value+"");
			if(dt.Year<T_String.GetDate().Year)	
			{
			...
			if(cb.SelectedValue+""=="")
			{
				MessageBox.Show(PublicFunction.L_Get_Msg("msg",219));
				return;
			}			
			...
			{	
				...
				string typ_old=T_String.GetDataFromSQL("TYP_ID","FILB01A","EMP_ID='"+EMP_ID+"'");
				string ngayvaolam=vs1.Rows[i]["INH_DT"]+"";					
				string SEQ_NO=T_String.GetMax("MAX(SEQ_NO)","FILB09A")+"";
				//chi them duoc ngay chuyen > ngay chuyen cuoi cung
				if(T_String.IsNullTo0(T_String.GetDataFromSQL("count(*)","FILB09A","EMP_ID='"+EMP_ID+"' AND SWI_DT>='"+((DateTime)dt1.Value).ToString("yyyy/MM/dd")+"'"))>0)
				{
					MessageBox.Show("Can insert this row");
					return;
				}
				SqlTransaction tran=con.BeginTransaction();
				try
				{	
					sql="Insert Into FILB09A(SEQ_NO,EMP_ID,TYP_I1,TYP_I2,SWI_DT,NOT_DR,"
						+"LST_MN,LST_DT) values("
						+SEQ_NO+","
						+"N'"+EMP_ID+"','"+cb.SelectedValue+"','"+typ_old +"',"
...
//					PublicFunction.SQL_Execute(sql,con);
					//update FILB01A
					sql="UPDATE FILB01A SET TYP_ID='"+cb.SelectedValue+"' WHERE EMP_ID='"+EMP_ID+"'";
