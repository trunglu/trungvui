...
namespace GP8000.Attendance
{
	...
	/// </summary>
	public class frmTaInitMonthAddUp : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmTaInitMonthAddUp";
			this.Text = "frmTaInitMonthAddUp";
		...
		{
			if(MessageBox.Show(PublicFunction.L_Get_Msg("msg",122),this.Text,MessageBoxButtons.OKCancel)==DialogResult.OK)
			{
				DateTime d1=(DateTime)dt1.Value;
				DateTime d2=(DateTime)dt2.Value;
				string sql=string.Format("Delete  From {0} where YYY_MM between '",Function.Common.Ints.tbTongKet)+ d1.ToString("yyyyMM")+"'"
