...
//											Double LT=T_String.TruTG(t1,c1);
//											if(t1>c2)
//												LT=T_String.TruTG(c2,c1);
//											else
//												LT=T_String.TruTG(t1,c1);
										Double LT=GetHourAndPhep(c1,t1,phep);
										if(t1>c2)
											LT=GetHourAndPhep(c1,c2,phep);
										else
											LT=GetHourAndPhep(c1,t1,phep);
//										if(T_String.TruTG(LT,ONN_MN)<=0)// thai san
//										{
											Note("Late"+";");
											NOT_D1+=j.ToString("00");
...
//										if(T_String.TruTG(EA,OFF_MN)<0)// thai san
//										{
											Note("Early"+";");
											NOT_D1+=j.ToString("00");											
