...
{
	/// <summary>
	/// Summary description for frmTaJuryType.
	/// </summary>
	public class frmTaJuryType : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmTaJuryType";
			this.Text = "frmTaJuryType";
			this.Load += new System.EventHandler(this.frmTaJuryType_Load);
