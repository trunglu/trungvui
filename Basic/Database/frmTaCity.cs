...
namespace GP8000.Database
{
	...
	/// </summary>
	public class frmTaCity : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.vs.Name = "vs";
			this.vs.Size = new System.Drawing.Size(440, 148);
		...
		{					
			if (e.Button.Equals(nav.cmd_add))
			{
				if (vs.Rows.Count==1 || (int)vs.Rows[vs.Rows.Count-1].UserData!=2)					
					nav.ToolBar_Click(e);									
				vs.Rows[vs.Rows.Count-1]["CIT_ID"]=T_String.GetMax("MAX(CIT_ID)","FILA03A").ToString("000");
				return;
			}
