...
{
	/// <summary>
	/// Summary description for frmTaCity.
	/// </summary>
	public class frmTaNativePlace : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.vs.Name = "vs";
			this.vs.Size = new System.Drawing.Size(672, 332);
			...
			this.panel1.Size = new System.Drawing.Size(680, 340);
			...
			this.Name = "frmTaNativePlace";
			this.Text = "frmTaNativePlace";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmTaCity_Load);
		...
		private void frmTaCity_Load(object sender, System.EventArgs e)
		{
		...
		{					
			if (e.Button.Equals(nav.cmd_add))
			{
				if (vs.Rows.Count==1 || (int)vs.Rows[vs.Rows.Count-1].UserData!=2)					
					nav.ToolBar_Click(e);									
				vs.Rows[vs.Rows.Count-1]["NAT_ID"]=T_String.GetMax("MAX(NAT_ID)","FILA18A").ToString("000");
				return;
			}
