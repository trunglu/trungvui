...
namespace GP8000.Database
{
	...
	/// </summary>
	public class frmTaGraduation : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmTaGraduation";
			this.Text = "frmTaGraduation";
		...
		{					
			if (e.Button.Equals(nav.cmd_add))
			{
				if (vs.Rows.Count==1 || (int)vs.Rows[vs.Rows.Count-1].UserData!=2)					
					nav.ToolBar_Click(e);									
				vs.Rows[vs.Rows.Count-1]["GRA_ID"]=T_String.GetMax("MAX(GRA_ID)","FILA10A").ToString("000");
				return;
			}
