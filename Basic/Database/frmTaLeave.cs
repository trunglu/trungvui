...
{
	/// <summary>
	/// Summary description for frmTaLeave.
	/// </summary>
	public class frmTaLeave : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmTaLeave";
			this.Text = "frmTaLeave";
			this.Load += new System.EventHandler(this.frmTaLeave_Load);
		...
		{
			if(vs.Rows[vs.Row]["LEA_ID"]+""=="001")
				e.Cancel=true;
			if(vs.Cols[e.Col].Name=="LEA_NM" && vs.Row>0 && vs.Rows[vs.Row].UserData+""!="2")
				e.Cancel=true;
		}
	}
}
