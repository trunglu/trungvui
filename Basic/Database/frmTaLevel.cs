...
namespace GP8000.Database
{
	...
	/// </summary>
	public class frmTaLevel : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmTaLevel";
			this.Text = "frmTaLevel";
		...
		{					
			if (e.Button.Equals(nav.cmd_add))
			{
				if (vs.Rows.Count==1 || (int)vs.Rows[vs.Rows.Count-1].UserData!=2)					
					nav.ToolBar_Click(e);									
				vs.Rows[vs.Rows.Count-1]["LEV_ID"]=T_String.GetMax("MAX(LEV_ID)","FILA19A").ToString("000");
				return;
			}
