...
{
	/// <summary>
	/// Summary description for frmTaProfession.
	/// </summary>
	public class frmTaProfession : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.vs.Name = "vs";
			this.vs.Size = new System.Drawing.Size(460, 222);
			...
			this.Name = "frmTaProfession";
			this.Text = "frmTaProfession";
			this.Load += new System.EventHandler(this.frmTaProfession_Load);
		...
		private void frmTaProfession_Load(object sender, System.EventArgs e)
		{
		...
		{					
			if (e.Button.Equals(nav.cmd_add))
			{
				if (vs.Rows.Count==1 || (int)vs.Rows[vs.Rows.Count-1].UserData!=2)					
					nav.ToolBar_Click(e);									
				vs.Rows[vs.Rows.Count-1]["PRO_ID"]=T_String.GetMax("MAX(PRO_ID)","FILA05A").ToString("000");
				return;
			}
