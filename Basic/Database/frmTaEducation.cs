...
{
	/// <summary>
	/// Summary description for frmTaEducation.
	/// </summary>
	public class frmTaEducation : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel3.Size = new System.Drawing.Size(676, 36);
			...
			this.vs.Name = "vs";
			this.vs.Size = new System.Drawing.Size(668, 260);
			...
			this.Name = "frmTaEducation";
			this.Text = "frmTaEducation";
			this.Load += new System.EventHandler(this.frmTaEducation_Load);
		...
		private void frmTaEducation_Load(object sender, System.EventArgs e)
		{
		...
		{					
			if (e.Button.Equals(nav.cmd_add))
			{
				if (vs.Rows.Count==1 || (int)vs.Rows[vs.Rows.Count-1].UserData!=2)					
					nav.ToolBar_Click(e);									
				vs.Rows[vs.Rows.Count-1]["EDU_ID"]=T_String.GetMax("MAX(EDU_ID)","FILA04A").ToString("000");
				return;
			}
