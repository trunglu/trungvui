...
namespace Basic.Form
{
	...
	/// </summary>
	public class frmControlTable1 : System.Windows.Forms.Form
	{
		...
		private void vs1_DoubleClick(object sender, System.EventArgs e)
		{
			...
			{			
				...
				int m=T_String.GetMax("MAX(ID)","SYS_LABEL_VS_ATT","NAME=N'"+vs1.Rows[vs1.Row]["ID"]+"'");
