...
namespace Basic.Form
{
	...
	/// </summary>
	public class frmUserForWeb : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.lb1.Name = "lb1";
			this.lb1.Size = new System.Drawing.Size(120, 24);
			this.lb1.TabIndex = 3;
			...
			this.lb2.Name = "lb2";
			this.lb2.Size = new System.Drawing.Size(120, 24);
			this.lb2.TabIndex = 5;
			...
			this.lb3.Name = "lb3";
			this.lb3.Size = new System.Drawing.Size(120, 24);
			this.lb3.TabIndex = 7;
			...
			this.lb4.Name = "lb4";
			this.lb4.Size = new System.Drawing.Size(120, 24);
			this.lb4.TabIndex = 9;
		...
		private void show_txt()
		{
			...
			{
				txt1.Text=vs.Rows[vs.Row]["USR_ID"]+"";
				txt2.Text=vs.Rows[vs.Row]["USR_NM"]+"";
				txt3.Text=txt4.Text="";
				try
				{
...
//						return ;					
//					}					
					vs.Rows[row]["PAS_DR"]=txt3.Text;
					vs.Rows[row]["USR_ID"]=txt1.Text;
					vs.Rows[row]["USR_NM"]=txt2.Text;					
					nav1.ToolBar_Click(e);
					if (vs.Rows.Count==1 || (int)vs.Rows[vs.Rows.Count-1].UserData!=2)
					{
						txt1.ReadOnly=txt2.ReadOnly=txt3.ReadOnly=txt4.ReadOnly=true;
				...
				{
					if (vs.Rows[vs.Row]["USR_ID"]+""=="admin")
					{
